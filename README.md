I have created a Wordle program using python and tkinter. The program consists of three classes: word, player, and game, along with a format file to store fonts and colors.
